...
Resource files are named _TMS-to-Tiles.<locale\>_, where _<locale\>_ matches locale’s 2 lowercase letters ISO 639-1 code. English localized resource file _TMS-to-Tiles.en_, French localized resource file _TMS-to-Tiles.fr_ and German localized resource file _TMS-to-Tiles.de_ are provided. Script can be easily localized to any other system’s locale by providing a corresponding resource file using English resource file as a template. 
...
**Note**: Edit _user-defined script variables settings section_ of user settings file _TMS-to-Tiles.ini_ to match files and folders of your local installation of Java and Mapsforge tile server. Always use slash character “/” as directory separator in _TMS-to-Tiles.ini_ file, for Microsoft Windows too!   
...
* See output console for Mapsforge tile server’s output, download/render statistics, process steps carried out, etc. 
